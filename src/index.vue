...
locale:locale="locale /></p>
  ...
  <template v-if="computedConfig.googleTagManager || computedConfig.googleAnalytics || computedConfig.firebaseAnalytics">
  ...
  <p v-if="locale === 'de'><a href="https://leistungen/muster-datenschutzerklaerung.html" rel="noopener" target="_blank">Muster-Datenschutzerklärung</a> der <a href="https://www.ratgeberrecht.eu/datenschutz/datenschutzerklaerung-generator-dsgvo.html" rel="noopener" target="_blank">Anwaltskanzlei Weiß &amp; Partner</a></p>
  <p v-else><a href="https://www.ratgeberrecht.eu/leistungen/muster-datenschutzerklaerung.html" rel="noopener" target="_blank">Model Data Protection Statement</a> for <a href="https://www.ratgeberrecht.eu/" rel="noopener" target="_blank">Anwaltskanzlei Weiß &amp; Partner</a></p>
</template>
